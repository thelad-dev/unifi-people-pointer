...
def match_device(client: dict[str, Any], devices: list[dict[str, Any]]) -> dict[str, Any] | None:
...
def match_device_partial(client: dict[str, Any], devices: list[dict[str, Any]]) -> dict[str, Any] | None:
...
def get_manufacturer_hint(client: dict[str, Any], manufacturers: list[dict[str, Any]]) -> dict[str, Any] | None:
