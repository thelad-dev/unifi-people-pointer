...
class TestDeviceMatcher:
    ...
    def test_match_only_tracked_devices(self, devices_data):
        ...
        from custom_components.unifi_people_pointer.device_matcher import match_device, is_tracked
    ...
    def test_match_partial_hostname(self):
        ...
        from custom_components.unifi_people_pointer.device_matcher import match_device_partial
    ...
    def test_match_with_oui_prefix(self, devices_data, manufacturers_data):
        ...
        manufacturer = get_manufacturer_hint(client, manufacturers_data["manufacturers"])
