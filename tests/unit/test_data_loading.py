...
# Data loader helpers are still Phase 3 stubs (raise NotImplementedError).
pytestmark = pytest.mark.skip(reason="Requires Phase 3 data_loader implementation")
...
class TestDataLoading:
    ...
    def test_load_manufacturers_valid(self, mock_data_files):
        ...
        from custom_components.unifi_people_pointer.data_loader import (
            load_manufacturers,
        )
